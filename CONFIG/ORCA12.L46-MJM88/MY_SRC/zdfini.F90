...
CONTAINS
   ...
   SUBROUTINE zdf_init
      ...
      NAMELIST/namzdf/ rn_avm0, rn_avt0, nn_avb, nn_havtb, ln_zdfexp, nn_zdfexp,   &
         ...
         &              ln_kzlog_wri, ln_kztke_wri, ln_kztid_wri
      !!----------------------------------------------------------------------
      ...
      IF(lwp) THEN               !* Parameter print
         ...
         !{ DRAKKAR
         WRITE(numout,*) '      kz log output                    ln_kzlog_wri = ', ln_kzlog_wri
         WRITE(numout,*) '      kz tke output                    ln_kztke_wri = ', ln_kztke_wri
         WRITE(numout,*) '      kz tid output                    ln_kztid_wri = ', ln_kztid_wri
         !}
      ENDIF
