...
#  include "domzgr_substitute.h90"
   ...
   !! $Id: domain.F90 3162 2011-11-20 16:38:17Z cetlod $
...
CONTAINS
   ...
   SUBROUTINE dom_nam
      ...
      !!----------------------------------------------------------------------
      USE ioipsl
      NAMELIST/namrun/ nn_no   , cn_exp    , cn_ocerst_in, cn_ocerst_out, cn_dirout, cn_dirout2, &
         &             cn_dirout3, ln_rstart , nn_rstctl,   &
         &             nn_it000, nn_itend  , nn_date0    , nn_leapy     , nn_istate , nn_stock ,   &
         &             nn_write, nn_write2, nn_write3, ln_dimgnnn, ln_mskland  , ln_clobber   , nn_chunksz ,             &
      ...
      IF(lwp) THEN                  ! control print
         ...
         WRITE(numout,*) '      frequency of SSF output file    nn_write2  = ', nn_write2
         WRITE(numout,*) '      frequency of SSF output file    nn_write3  = ', nn_write3
         ...
         WRITE(numout,*) '      Output directory for SSF        cn_dirout2 = ', cn_dirout2
         WRITE(numout,*) '      Output directory for 5d         cn_dirout3 = ', cn_dirout3
