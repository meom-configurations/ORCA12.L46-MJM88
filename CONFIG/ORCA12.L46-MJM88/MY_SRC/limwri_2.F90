MODULE limwri_2
   ...
   PUBLIC   lim_wri_2_3       ! called by sbc_ice_lim_2
#endif
...
!  PUBLIC   lim_wri_alloc_2   ! called by nemogcm.F90
   ...
   REAL(wp), ALLOCATABLE, SAVE, DIMENSION(:,:,:) ::   zcmo2      ! Workspace array for netcdf writer. 
...
#   include "vectopt_loop_substitute.h90"
   ...
   !! $Id: limwri_2.F90 3200 2011-12-07 15:00:49Z cbricaud $
...
CONTAINS
   ...
   INTEGER FUNCTION lim_wri_alloc_2_3()
      !!-------------------------------------------------------------------
      !!                  ***   ROUTINE lim_wri_alloc_2_3  ***
      !!-------------------------------------------------------------------
      ALLOCATE( zcmo2(jpi,jpj,jpnoumax), STAT=lim_wri_alloc_2_3)
      !
      IF( lk_mpp               )   CALL mpp_sum ( lim_wri_alloc_2_3 )
      IF( lim_wri_alloc_2_3 /= 0 )   CALL ctl_warn('lim_wri_alloc_2_3: failed to allocate array zcmo2')
      !
   END FUNCTION lim_wri_alloc_2_3
