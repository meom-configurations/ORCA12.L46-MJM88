...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: tradmp.F90 3186 2011-11-27 08:16:19Z smasson $ 
...
!   {  A.L. : No 3D overflow restoring at Gibraltar Strait
!   {  JMM :  restoring at Gibraltar Strait for climatological run
...
!       }
       ...
       ! Lonmin     ! Lonmax       ! Latmin        ! Latmax       ! Band      ! min relax time   !
       !  deg E     ! deg E        !  deg N        ! Deg N        !  deg      !   days           !
       zlon1 = -66. ; zlon2 = 15.0 ;  zlat1 = -75. ; zlat2 = -60. ; zbw = 1.  ; ztrelax = 360. 

       zwedresto(:,:,:) = 0.0
       CALL resto_patch ( zlon1, zlon2, zlat1, zlat2, zbw, ztrelax , zwedresto )
       ! restore only in the upper 20 levels
       presto(:,:,1:20) = presto(:,:,1:20) + zwedresto(:,:,1:20)
      ...
      CALL wrk_dealloc( jpi, jpj, jpk, zdct, zwedresto )
