...
CONTAINS
   ...
   SUBROUTINE dia_wri_harm
      ...
      CALL dia_wri_dimg(TRIM(cdfile_name_T), TRIM(cltext), out_eta, 2*nb_ana, '2', cn_dirout )
#else
      DO jh = 1, nb_ana
      ...
      CALL dia_wri_dimg(TRIM(cdfile_name_U), TRIM(cltext), out_u, 2*nb_ana, '2', cn_dirout )
#else
      DO jh = 1, nb_ana
      ...
      CALL dia_wri_dimg(TRIM(cdfile_name_V), TRIM(cltext), out_v, 2*nb_ana, '2', cn_dirout )
#else
      DO jh = 1, nb_ana
