MODULE diawri
   ...
   !!   dia_wri_2     : create the standart output files
...
!}
   ...
   PUBLIC   dia_wri_2               ! routines called by step.F90 (dimgout only)
   PUBLIC   dia_wri_3               ! routines called by step.F90 (dimgout only)
