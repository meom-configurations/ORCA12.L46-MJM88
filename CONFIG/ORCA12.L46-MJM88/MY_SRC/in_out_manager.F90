MODULE in_out_manager   
   ...
   CHARACTER(len=255) ::  cn_dirout2 = "./"       !: prefix for model outputfile for SSF
   CHARACTER(len=255) ::  cn_dirout3 = "./"       !: prefix for model outputfile for 5d average
...
!{ DRAKKAR
   INTEGER       ::   nn_write2     =   0         !: second model standard output frequency (2D surface field)
                                                  !  if set to 0 no second output
   INTEGER       ::   nn_write3     =   0         !: third model standard output frequency (5d average )
                                                  !  if set to 0 no second output
!}
...
!$AGRIF_END_DO_NOT_TREAT
   ...
   INTEGER       ::   nwrite2                     !: second model standard output frequency (2D SURFACE field)
   INTEGER       ::   nwrite3                     !: third model standard output frequency (5d average )
   ...
   !! $Id: in_out_manager.F90 3170 2011-11-22 10:49:52Z cetlod $
