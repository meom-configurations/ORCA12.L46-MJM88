MODULE zdf_oce
   ...
   !{ DRAKKAR : dimgout support for various Kz
   LOGICAL , PUBLIC  ::  ln_kzlog_wri = .FALSE. !: output of log(kz)
   LOGICAL , PUBLIC  ::  ln_kztke_wri = .FALSE. !: output of kz_tke
   LOGICAL , PUBLIC  ::  ln_kztid_wri = .FALSE. !: output of kz_tide
   !}
