...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: trabbl.F90 3186 2011-11-27 08:16:19Z smasson $
      ...
      IF( nn_bbl_ldf == 1 ) THEN          !   diffusive bbl   !
         ...
         DO jj = 1, jpjm1                      ! (criteria for non zero flux: grad(rho).grad(h) < 0 )
            DO ji = 1, jpim1              
               ...
               ahu_bbl(ji,jj) = ( 0.5 - zsign ) * ahu_bbl_0(ji,jj) * ABS(mgrhu(ji,jj) ) ! masked diffusive flux coeff.
               !
               !                                                ! j-direction 
               ...
               ahv_bbl(ji,jj) = ( 0.5 - zsign ) * ahv_bbl_0(ji,jj) * ABS(mgrhv(ji,jj) )
               !
            END DO
         END DO
         !
